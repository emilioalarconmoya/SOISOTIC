...
Imports System
Imports System.Data
Partial Class modulo_gestion_gerencial_movimiento_x_mes
    Inherits System.Web.UI.Page
    Dim objWeb As CWeb
    Dim objSession As CSession
    Dim objInforme As New CInformeAnual
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            objWeb.LlenaDDL(ddlAgno, objLookups.Agnos2, "Agno_v", "Agno_t")
            ...
            ddlAgno.SelectedValue = Now.Year()
    ...
    Private Sub Consultar()
        ...
        objInforme.PeriodoInt = Me.ddlAgno.SelectedValue

        objInforme.Holding = Me.chkEmp.Checked
        objInforme.Inicializar()

        'Dim dt As DataTable
        objInforme.Cargar(Me.chkEmp.Checked, Me.txtRutEmpresa.Text, Me.ddlSucursal.SelectedValue, Me.ddlEjecutivo.SelectedValue, Me.ddlAgno.SelectedValue)
        ...
        'objChart.DtDatos = objInforme.CostoOticReal1
        ' '' End If
