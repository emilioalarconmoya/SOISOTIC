<%@ Page Language="VB" AutoEventWireup="false" CodeFile="generacion_certificados_aporte.aspx.vb" Inherits="modulo_administracion_generacion_certificados_aporte" %>
<%@ Register Src="~/contenido/ascx/cabeceraUsuario.ascx" TagName="cabeceraUsuario" TagPrefix="uc3" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Centificados de aportes</title>
...
<body id="body" runat="server">
    ...
    <div id="menu">
        ...
        <fieldset id="mantenedor" >
            <table style="width: 432px" class="TablaRechazo">
                <tr>
                    <td style="width: 100px; height: 31px;">
                        Se han generado&nbsp;<asp:Label ID="lblTotalCertificados" runat="server"></asp:Label>&nbsp;
                        nuevo(s) certificado(s) de aporte</td>
                </tr>
                <tr>
                    <td style="height: 31px;">
                        Para volver al listado de certificados haga clic
                        <asp:HyperLink ID="hplAqui" runat="server" NavigateUrl="~/modulo_administracion/listado_generacion_certificados_aporte.aspx">AQUI</asp:HyperLink></td>
                </tr>
            </table>
        </fieldset>       
    </div>
