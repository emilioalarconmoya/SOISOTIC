<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mantenedor_objeto.aspx.vb" Inherits="modulo_administracion_mantenedor_objeto" %>
        ...
        <fieldset id="mantenedor" >
            <div id="filtrosMantenedor">
                <table id="tablaFiltro" cellpadding="0" cellspacing="0" class="TablaInterior" width="90%">
                    <tr>
                        <th colspan="6">
                            <asp:Label ID="Label6" runat="server" Text="Buscador de objeto"></asp:Label></th>
                    </tr>
                    <tr>
                        <td class="AlineacionCentro" colspan="6" style="height: 25px">
                            <asp:Label ID="Label7" runat="server" Text="Código objeto :"></asp:Label>
                            <asp:TextBox ID="txtCodObjeto" runat="server" Width="5%"></asp:TextBox>
                            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                ControlToValidate="txtCodObjeto" ErrorMessage="Ingrese un número entero" ValidationExpression="\d+"
                                ValidationGroup="xx">*</asp:RegularExpressionValidator>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <asp:Label ID="Label8" runat="server" Text="Nombre objeto :"></asp:Label>
                            <asp:TextBox ID="txtNombreObjeto" runat="server"></asp:TextBox></td>
                    </tr>
                </table>
                ...
                <asp:GridView ID="grdResultados" runat="server" Width="70%" AutoGenerateColumns="False" CssClass="Grid" Height="0px">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descripci&#243;n objeto">
                            <ItemTemplate>
                                &nbsp;<asp:Label ID="lblDescripcionObjeto" runat="server" Text='<%# Bind("nombre") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="50%" />
                        </asp:TemplateField>
