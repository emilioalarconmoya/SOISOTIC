<%@ Page Language="VB" AutoEventWireup="false" CodeFile="buscador_otec.aspx.vb" Inherits="modulo_administracion_buscador_otec" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Buscador otec</title>
    ...
    <form id="form1" runat="server">
        <div id="PopUpEmpresas">
            ...
            <div id="filtrosBusqueda">
                <asp:Label ID="lblRut" runat="server" Text="Rut Otec :"></asp:Label>
                <asp:TextBox ID="txtRutOtec" runat="server" Width="80px"></asp:TextBox>
                <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="El Rut ingresado no es valido" Text="*" ControlToValidate="txtRutOtec" ValidationGroup="ValidaRut"></asp:CustomValidator>
            ...
            <div id="resultadoBusqueda">
                <asp:GridView ID="grdOtec" runat="server" CssClass="Grid" AutoGenerateColumns="False" Width="650px">
                    <Columns>
