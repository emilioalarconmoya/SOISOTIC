<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mantenedor_rubros_m.aspx.vb" Inherits="modulo_administracion_mantenedor_rubros_m" %>
        ...
        <fieldset id="mantenedor" >
            <div id="filtrosMantenedor">
                <table id="tablaNuevoObjeto" cellpadding="0" cellspacing="0" class="TablaInterior"
                    ...
                    <tr>
                        <th colspan="6">
                            <asp:Label ID="lblTipo" runat="server" Text="Nuevo rubro"></asp:Label></th>
                    </tr>
                    <tr>
                        <td class="AlineacionIzquierda" colspan="6" style="height: 25px">
                            &nbsp;<asp:Label ID="Label8" runat="server" Text="Nombre rubro :"></asp:Label>
                            <asp:TextBox ID="txtNombreRubro" runat="server" Width="45%"></asp:TextBox>
                            &nbsp;&nbsp;
                            <asp:Label ID="Label7" runat="server" Text="Código rubro :"></asp:Label>
                            <asp:Label ID="lblCodRubro" runat="server" Font-Bold="True" Visible="False"></asp:Label>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                    </tr>
                </table>
                <br />
