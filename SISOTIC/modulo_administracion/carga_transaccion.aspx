<%@ Page Language="VB" AutoEventWireup="false" CodeFile="carga_transaccion.aspx.vb" Inherits="modulo_administracion_carga_inicio" %>
<%@ Register Src="~/contenido/ascx/cabeceraUsuario.ascx" TagName="cabeceraUsuario" TagPrefix="uc3" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Carga de Inicio</title>
    ...
    <div>
        <div id="contenedor" align="center">
            ...
            <div id="resultadoCarga">
                ...
                <br />
                <br />
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/contenido/Plantilla/Formato CargaInicio.xls">Archivo con formato de la carga</asp:HyperLink><br />
                <br />
                <br />
                <asp:Label ID="msjError" runat="server" ForeColor="Red"></asp:Label><br />
            </div>
        </div>
        <div id="pie">
