...
Imports System
Imports System.Data
Partial Class modulo_administracion_mantenedor_perfil_objeto
    ...
    Public Sub Consultar()
        ...
        Dim dt As DataTable
        dt = objMantPerfilObjeto.Consultar
    ...
    Protected Sub btnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Me.ClientScript.RegisterStartupScript(Me.GetType(), "ClientScript", "<script language='javascript' type='text/javascript'> " _
                    & "alert('¡Usuario eliminado exitosamente!');document.location=('./mantenedor_perfil_objeto.aspx');</script>")
    End Sub
