<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mantenedor_perfil.aspx.vb" Inherits="modulo_administracion_mantenedor_perfil" %>
        ...
        <div id="PestañasMantenedor">
            <ul>
                <li class="PestañasMantenedorseleccionada">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="mantenedor_perfil.aspx"><b>Datos</b></asp:HyperLink>
                </li>
                <li>
        ...
        <fieldset id="mantenedor" >
            <div id="filtrosMantenedor">
                <table id="tablaFiltro" cellpadding="0" cellspacing="0" class="TablaInterior" width="90%">
                    <tr>
                        <th colspan="6">
                            <asp:Label ID="Label6" runat="server" Text="Buscador de perfil"></asp:Label></th>
                    </tr>
                    <tr>
                        <td class="AlineacionCentro" colspan="6" style="height: 25px">
                            <asp:Label ID="Label7" runat="server" Text="Código perfil :"></asp:Label>
                            <asp:TextBox ID="txtCodPerfil" runat="server" Width="5%"></asp:TextBox>
                            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                ControlToValidate="txtCodPerfil" ErrorMessage="Ingrese un número entero" ValidationExpression="\d+"
                                ValidationGroup="xx">*</asp:RegularExpressionValidator>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <asp:Label ID="Label8" runat="server" Text="Nombre perfil :"></asp:Label>
                            <asp:TextBox ID="txtNombrePerfil" runat="server"></asp:TextBox></td>
                    </tr>
                </table>
                ...
                <asp:GridView ID="grdResultados" runat="server" Width="90%" AutoGenerateColumns="False" CssClass="Grid" Height="0px">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descripci&#243;n perfil">
                            <ItemTemplate>
                                &nbsp;<asp:Label ID="lblDescripcionPerfil" runat="server" Text='<%# Bind("nombre") %>'></asp:Label>
                            </ItemTemplate>
