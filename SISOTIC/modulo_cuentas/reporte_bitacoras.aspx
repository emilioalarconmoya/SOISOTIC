    ...
    <div id="contenido">
     <table class="TituloGrupo">
        ...
        <table cellpadding="0" cellspacing="0" class="TablaInterior" id="tbBitacoraCurso" runat="server" visible="false" style="width: 976px">
            <tr>
                <td class="AlineacionDerecha" style="width: 13%; height: 17px;">
            ...
            <tr>
                <td class="AlineacionDerecha" style="width: 14%; height: 18px;">
                    <asp:Label ID="Label8" runat="server" Font-Bold="False" Text="Correlativo curso:" Width="108px"></asp:Label></td>
                ...
                <td class="AlineacionDerecha" style="width: 14%; height: 18px;" colspan="3">
            ...
            <tr>
                <td class="AlineacionDerecha" style="width: 14%">
                ...
                <td class="AlineacionDerecha" style="width: 14%" colspan="3">
        ...
        <table cellpadding="0" cellspacing="0" class="TablaInterior" id="tbBitacoraCursoInterno" runat="server" visible="false" style="width: 976px">
            <tr>
                <td class="AlineacionDerecha" style="width: 13%; height: 17px;">
                    <asp:Label ID="Label9" runat="server" Text="Correlativo" Font-Bold="False"></asp:Label></td>
                <td style="width: 2%; height: 17px;">
                    :</td>
                <td class="AlineacionIzquierda" style="width: 10%; height: 17px;">
                    <asp:Label ID="lblCorrelativoInterno" runat="server" Font-Bold="True"></asp:Label></td>
                <td class="AlineacionDerecha" style="width: 10%; height: 17px;">
                    <asp:Label ID="Label16" runat="server" Text="Estado actual"></asp:Label></td>
                <td style="width: 2%; height: 17px;">
                    :</td>
                <td class="AlineacionIzquierda" style="width: 10%; height: 17px;">
                    <asp:Label ID="lblEstadoInterno" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="AlineacionDerecha" style="width: 13%">
                    <asp:Label ID="Label27" runat="server" Text="Correlativo Empresa" Font-Bold="False"></asp:Label></td>
                <td style="width: 2%">
                    :</td>
                <td class="AlineacionIzquierda" style="width: 10%">
                    <asp:Label ID="lblCorrelativoEmpresaInterno" runat="server" Font-Bold="True"></asp:Label></td>
                <td class="AlineacionDerecha" style="width: 10%">
                    <asp:Label ID="Label30" runat="server" Text="Fecha"></asp:Label></td>
                <td style="width: 2%">
                    :</td>
                <td class="AlineacionIzquierda" style="width: 10%">
                    <asp:Label ID="lblFechaInterno" runat="server"></asp:Label></td>
                </tr>
        </table>
