...
Partial Class Reportes_ficha_curso_contratado
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If objSession.EsCliente Then
            ...
            Me.trComentario.Visible = False
            Me.hplEstado.Enabled = False
        End If
        ...
        End If
        If (ViewState("codEstadoCurso") <> 1 Or ViewState("codEstadoCurso") <> 2) And (objSession.EsClienteIngresoCurso Or objSession.EsCliente) Then
    ...
    Private Sub Consultar()
        Try
            ...
            Me.lblCUhoras.Text = objReporte.Horas '+ objCurso2.Horas
    ...
    Protected Sub btnCambiaAIngresado_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCambiaAIngresado.Click
        Try
            ...
            objCursoContratado.RutCliente = objSession.RutCliente
    ...
    Protected Sub BtnVolver3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnVolver3.Click
        Response.Redirect("../modulo_cursos/buscador_cursos.aspx")
    End Sub
    ...
    Protected Sub grdComentarios_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdComentarios.RowDataBound
        ...
        Catch ex As Exception
            EnviaError("modulo_cuentas/ficha_curso_contratado--> grdComentarios_RowDataBound" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnAutorizar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAutorizar.Click
        Try
            ...
            Consultar()
        Catch ex As Exception
            EnviaError("modulo_cuentas/ficha_curso_contratado--> btnAutorizar_Click" & ex.Message)
        End Try
    End Sub
End Class
