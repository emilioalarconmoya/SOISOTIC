...
<body id="body" runat="server">
    ...
    <div id="menu">
        ...
        <div id="contenido">            
            <div id="resultados">
                <asp:Wizard id="wizardCursoInterno" runat="server" ActiveStepIndex="0" Width="98%">
                                ...
                                <tr>
                                    <td class="tdTextos" style="width: 835px">
                                        ...
                                        <div class="AlineacionDerecha">
                                            &nbsp;<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/contenido/Plantilla/participantes.xls">formato para participantes</asp:HyperLink>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 835px" valign="top">
                                        ...
                                        &nbsp;
                                        <asp:Button ID="btnActualizaListaAlumnos" runat="server" Text="Eliminar alumnos" Visible="False" />
                                    </td>
                                </tr>
                            </table>
                        </asp:WizardStep>
