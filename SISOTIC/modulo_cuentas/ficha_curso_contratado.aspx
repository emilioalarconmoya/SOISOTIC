                    ...
                    <table id="tablaPeriodoActual">
                        ...
                        <tr>
                            <td valign="top" style="width: 50%; height: 113px;">
                                <table cellpadding="0" cellspacing="0" class="TablasCuentas">
                                    ...
                                    <tr>
                                        <td class="AlineacionIzquierda" colspan="3" style="height: 12px">
                                            <asp:Label ID="Label49" runat="server" Text="CORRELATIVO EMPRESA: "></asp:Label><asp:Label
                                                ID="lblCorrelativoEmpresa" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="TablasCuentas" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="AlineacionIzquierda" style="width: 31%; height: 12px">
                                        <asp:Label ID="Label7" runat="server" Text="Costo OTIC Viático"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 4%; height: 12px">
                                        <asp:Label ID="Label68" runat="server" Text="$"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 20%; height: 12px">
                                        <asp:Label ID="lblCOCostoOticViatico" runat="server" Text="0"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 2%; height: 12px">
                                    </td>
                                    <td class="AlineacionIzquierda" style="width: 29%; height: 12px">
                                        <asp:Label ID="Label50" runat="server" Text="Post contrato: "></asp:Label></td>
                                    <td class="AlineacionDerecha" style="height: 12px">
                                        <asp:Label ID="lblCOposContrato" runat="server" Text="Label"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td class="AlineacionIzquierda" style="width: 31%; height: 12px">
                                        <asp:Label ID="Label9" runat="server" Text="Gasto Emp. Viático"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 4%; height: 12px">
                                        <asp:Label ID="Label69" runat="server" Text="$"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 20%; height: 12px">
                                        <asp:Label ID="lblCOGastoEmpViatico" runat="server" Text="0"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 2%; height: 12px">
                                    </td>
                                    <td class="AlineacionIzquierda" style="width: 29%; height: 12px">
                                ...
                                <tr>
                                    <td class="AlineacionIzquierda" style="width: 31%; height: 16px">
                                        <asp:Label ID="Label21" runat="server" Text="Costo OTIC Traslado"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 4%; height: 16px">
                                        <asp:Label ID="Label70" runat="server" Text="$"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 20%; height: 16px">
                                        <asp:Label ID="lblCOCostoOticTraslado" runat="server" Text="0"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 2%; height: 16px">
                                    </td>
                                    <td class="AlineacionIzquierda" style="width: 29%; height: 16px">
                                    </td>
                                ...
                                <tr>
                                    <td class="AlineacionIzquierda" style="width: 31%; height: 16px">
                                        <asp:Label ID="Label22" runat="server" Text="Gasto Emp. Traslado"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 4%; height: 16px">
                                        <asp:Label ID="Label71" runat="server" Text="$"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 20%; height: 16px">
                                        <asp:Label ID="lblCOGastoEmpTraslado" runat="server" Text="0"></asp:Label></td>
                                    <td class="AlineacionDerecha" style="width: 2%; height: 16px">
                                    </td>
                                    <td class="AlineacionIzquierda" style="width: 29%; height: 16px">
                                    </td>
                        ...
                        <tr>
                          ...
                          <table class="TablaInterior">
                            <tr id="trComentario" runat="server">
                            <td class="Alineacionderecha" colspan="2" style="height: 15px" valign="top">
                                comentarios:<br />
                                <asp:TextBox ID="txtComentarios" runat="server" Height="96px" Width="948px" TextMode="MultiLine"></asp:TextBox><br />
