...
#Region "SELECT"
        ...
        Public Function s_franquicia(ByVal lngRut As Long)
            ...
            strQuery = _
                "select  valor_hora_sence.agno 'año', 0 as valor from valor_hora_sence " _
                & "where valor_hora_sence.agno not in (select franquicia.agno from franquicia where rut=[0]) " _
                & " Union " _
                & "Select franquicia.agno 'año' ,franquicia.valor " _
                & " From franquicia " _
                & " Where Rut = [0] " _
                & " order by agno "
...
& "isnull(f.num_voucher,0) num_voucher "
        ...
        End Function
        ''Consulta el valor de la hora sence en un año ,modalidad  y curso específico 
