        ...
        <table style="width: 980px;" cellpadding="0" cellspacing="0" id="tablaPeriodoActual">
            ...
            <tr>
                ...
                <td class="titDatos1" style="width: 20px; height: 15px;" valign="top">
                    <asp:Label ID="Label29" runat="server" Text="Fax" Font-Bold="True"></asp:Label></td>
                <td class="dosPuntos" style="width: 2px; height: 15px;">
                    :</td>
                <td class="AlineacionIzquierda" style="width: 150px; height: 15px;">
            ...
            <tr>
                <td class="titDatos1" colspan="3" style="width: 40px; height: 12px">
                </td>
                <td class="titDatos1" style="width: 20px; height: 12px" valign="top">
                    <asp:Label ID="Label31" runat="server" Text="Email" Font-Bold="True"></asp:Label></td>
                <td class="dosPuntos" style="width: 2px; height: 12px">
                    :</td>
                <td class="AlineacionIzquierda" colspan="4" style="width: 150px; height: 12px">
