        ...
        <table style="width: 750px;" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="AlineacionIzquierda" width="40%">
                    ...
                    <asp:Label ID="lblFono" runat="server" Font-Bold="True"></asp:Label>
                    <asp:Label ID="Label29" runat="server" Text="Fax" Font-Bold="True" Width="45px"></asp:Label>
                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Text=":" Width="3px"></asp:Label>
        ...
        <table style="width: 800px;margin-left: auto; margin-right: auto;">
            ...
            <tr>
                ...
                <td class="AlineacionIzquierda" colspan="" valign="top">
                    ...
                    <asp:Label ID="Label47" runat="server" Text="Fax" Width="40px"></asp:Label>
                    <asp:Label ID="Label25" runat="server" Font-Bold="True" Text=":" Width="3px"></asp:Label>
                    <asp:Label ID="lblCOfaxOtec" runat="server" Text="Label"></asp:Label><br />
