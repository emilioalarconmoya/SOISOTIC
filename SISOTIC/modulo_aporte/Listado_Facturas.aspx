<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Listado_Facturas.aspx.vb" Inherits="modulo_aporte_Listado_Facturas" %>
                        ...
                        <asp:TemplateField HeaderText="Datos curso">
                            ...
                            <ItemTemplate>
                                <table cellpadding="0" cellspacing="0" class="TablaInterior">
                                    ...
                                    <tr>
                                        <td style="width: 38px" class="AlineacionIzquierda">
                                            <asp:Label ID="Label16" runat="server" Text="Nro. egreso"></asp:Label></td>
                                        <td class="DosPuntos">
                                            :</td>
                                        <td style="width: 70px" class="AlineacionIzquierda">
                                            <%--<asp:Label ID="lblNroEgreso" runat="server" Text='<%# Bind("nro_egreso") %>'></asp:Label></td>--%>
                                    </tr>
                                </table>
                            </ItemTemplate>
                        </asp:TemplateField>
