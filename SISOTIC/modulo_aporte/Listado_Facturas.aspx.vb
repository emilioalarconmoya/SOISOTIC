...
Imports System
Imports System.Data
Partial Class modulo_aporte_Listado_Facturas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                Me.btnPopUpEmpresa.Attributes.Add("onClick", "popup_pos('../modulo_cursos/buscador_empresas.aspx?campo=txtRutEmpresa', 'NewWindow1', 380, 700, 100, 100);return false;")
                ...
                objWeb.AgregaValorDDL(ddlEstadofactura, "Todos", "0")
        ...
        Catch ex As Exception
            EnviaError("modulo_aporte_Listado_Facturas:Page_Load-->" & ex.Message)
        End Try
    End Sub
    ...
    Public Sub Consultar()
        ...
        Catch ex As Exception
            EnviaError("modulo_aporte_Listado_Facturas.vb:Consultar->" & ex.Message)
        End Try
    ...
    Protected Sub grdResultados_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdResultados.RowDataBound
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                hplEstado.NavigateUrl = "../modulo_cursos/reporte_bitacoras.aspx?codCurso=" & hdf1.Value & "&tipo=3" & "&estado=" & hdfCodEstadoFactura.Value
                ...
                hpl5.NavigateUrl = "../modulo_aporte/mantenedor_factura.aspx?CodCurso=" & hdf1.Value & "&EstadosFacturas=" & hdf5.Value & "&NumFactura=" & hdf7.Value & "&Monto=" & lbl1.Text & "&FechaFactura=" & lbl2.Text & "&FechaRecepcion=" & lbl3.Text & "&FechaPago=" & lbl4.Text & "&Observaciones=" & "&Agno=" & Me.ddlAgnos.SelectedValue    'MANTENEDOR FACTURA"
            ...
            End If
        Catch ex As Exception
            EnviaError("modulo_aporte_Listado_Facturas.aspx.vb:grdResultados_RowDataBound->" & ex.Message)
        End Try
