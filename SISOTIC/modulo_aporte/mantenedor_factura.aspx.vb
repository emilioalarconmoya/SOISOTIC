...
Imports System
Imports System.Data
Partial Class modulo_aporte_mantenedor_factura
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            EnviaError("modulo_aporte_mantenedor_factura.aspx.vb:Page_Load-->" & ex.Message)
        End Try
    ...
    Public Function ValidaDatosPaso1() As Boolean
        ...
        Catch ex As Exception
            EnviaError("modulo_aporte_mantenedor_factura.aspx.vb:ValidaDatosPaso1-->" & ex.Message)
        End Try
    End Function
    Public Sub CargarDatos()
        ...
        Catch ex As Exception
            EnviaError("modulo_aporte_mantenedor_factura.aspx.vb:CargarDatos-->" & ex.Message)
        End Try
    ...
    Protected Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        Try
            ...
            Me.hdfEnvioDatos.Value = 0
        Catch ex As Exception
            EnviaError("modulo_aporte_mantenedor_factura.aspx.vb:btnGrabar_Click-->" & ex.Message)
        End Try
    ...
    Protected Sub btnInsertar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnInsertar.Click
        Try
            ...
            Me.hdfEnvioDatos.Value = 0
        Catch ex As Exception
            EnviaError("modulo_aporte_mantenedor_factura.aspx.vb:btnInsertar_Click-->" & ex.Message)
        End Try
