        ...
        Try
            ...
            If respuesta_web <> "SIN_DATA" Then
                ...
                If Not objOtec.Inicializar1(CLng(xml_RutOtec)) Then
                    lblMensaje.Text = "No existe el rut de la otec en la base de datos del sistema"
                    Exit Sub
                Else
                ...
                If xml_NombreModalidad.Contains("Presencial") Or xml_NombreModalidad.Contains("sencial") Then
                    xml_CodModalidad = 1
                ElseIf xml_NombreModalidad.Contains("E-Learning") Or xml_NombreModalidad.Contains("Elearning") Or xml_NombreModalidad.Contains("ELearning") Then
                    xml_CodModalidad = 2
