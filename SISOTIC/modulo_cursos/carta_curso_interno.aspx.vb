...
Imports System
Imports System.Data
Partial Class modulo_cursos_carta_curso_interno
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos_carta_curso_interno:Page_Load-->" & ex.Message)
        End Try
    End Sub
    Private Sub Consultar()
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos_carta_curso_interno:Consultar-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub grdListadoAlumnos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdListadoAlumnos.RowDataBound
        Try
            ...
            End If
        Catch ex As Exception
            EnviaError("modulo_cursos_carta_curso_interno:grdListadoAlumnos_RowDataBound-->" & ex.Message)
        End Try
