<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mantenedor_cursos.aspx.vb" Inherits="modulo_cursos_mantenedor_cursos" %>
    ...
    <div id="menu">
        ...
        <div id="contenido" runat="server" >            
            <div id="resultados" runat="server" >
                <asp:Wizard id="wizardCurso" runat="server" ActiveStepIndex="0" 
                    CssClass="wizardCurso" >
                    <WizardSteps>
                        <asp:WizardStep ID="WizardStep1" runat="server" Title="Datos curso" StepType="Start" >
                            <table cellpadding="0" cellspacing="0" class="Grid" width="840" id="tablaPaso1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 293px" class="tdTextos" valign="top">
                                        <asp:TextBox ID="txtRutEmpresa" runat="server" MaxLength="13" TabIndex="1" ></asp:TextBox>
                                         <asp:Button ID="Button1" runat="server" Visible="true" Height="1px" Width="1px" CssClass="invisible" />
                                ...
                                <tr>
                                    <td class="tdTextos" style="width: 127px" valign="top" rowspan="2">
                                        <asp:Label ID="Label10" runat="server" Text="Obvervaci&#243;n"></asp:Label>
                                        &nbsp;
                                    </td>
                                    <td style="width: 2px" valign="top" rowspan="2">
                                        :</td>
                                    <td class="tdTextos" style="width: 293px" valign="top" rowspan="2">
                                        ...
                                        &nbsp;</td>
                                    <td class="tdTextos" style="width: 126px" valign="top">
                                        <asp:Label ID="Label89" runat="server" Text="CONTACTO PRINCIPAL"></asp:Label>
                                    </td>
                                    <td style="width: 2px" valign="top">
                                        :</td>
                                    <td class="tdTextos" style="width: 290px" valign="top">
                                        <asp:Label ID="lblContactoPrincipal" runat="server" Visible="false"></asp:Label>
                                        <asp:DropDownList ID="ddlContactoPrincipal" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr runat="server">
                                    <td runat="server" class="tdTextos" style="width: 126px" valign="top">
                                        <asp:Label ID="Label19" runat="server" Text="Contacto Adicional"></asp:Label>
                                    </td>
                                    <td runat="server" style="width: 2px" valign="top">
                                        :</td>
                                    <td runat="server" class="tdTextos" style="width: 290px" valign="top">
                            ...
                            <table cellpadding="0" cellspacing="0" class="Grid" width="840" id="tablaPaso4" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 280px; height: 328px;" valign="top"><table cellpadding="0" cellspacing="0" class="Grid" width="270">
                                        ...
                                        <tr>
                                            <td class="AlineacionDerecha" colspan="4">
                                                <asp:Label ID="Label64" runat="server" Text="Total Vi&#225;tico :"></asp:Label>
