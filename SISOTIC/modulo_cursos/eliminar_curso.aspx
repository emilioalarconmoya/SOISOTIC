<%@ Page Language="VB" AutoEventWireup="false" CodeFile="eliminar_curso.aspx.vb" Inherits="modulo_cursos_eliminar_curso" %>
     ...
     <table id="tablaDatosAlumno">
                        <tr>
                            <th width="980px" valign="top" class="TituloGrupo">
                                <asp:Label ID="Label4" runat="server" Text="Eliminación de curso"></asp:Label>  </th>                         
                        </tr>
                     </table>
        ...
        <tr>
            ...
            <tr>
                <td style="width: 50%" valign="top">
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Text="Ingrese el motivo de la eliminación del curso"></asp:Label></td>
                <td style="width: 50%">
                    <asp:TextBox ID="txtGlosa" runat="server" Height="50px" Width="200px" MaxLength="4000"></asp:TextBox></td>
            </tr>
        </table>
        <br />
        <br />
        <br />
        <br />
        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" />&nbsp;<asp:Button ID="btnCancelar"
