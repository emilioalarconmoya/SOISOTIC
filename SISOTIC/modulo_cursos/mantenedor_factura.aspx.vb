...
Imports System
Imports System.Data
Partial Class modulo_cursos_mantenedor_factura
    ...
    Public Sub CargarDatos()
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/modulo_cursos_mantenedor_factura.aspx.vb:CargarDatos-->" & ex.Message)
        End Try
    ...
    Protected Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        Try
            ...
            Me.hdfEnvioDatos.Value = 0
        Catch ex As Exception
            EnviaError("modulo_cursos/modulo_cursos_mantenedor_factura.aspx.vb:btnGrabar_Click-->" & ex.Message)
        End Try
    ...
    Protected Sub btnInsertar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnInsertar.Click
        Try
            ...
            Me.hdfEnvioDatos.Value = 0
        Catch ex As Exception
            EnviaError("modulo_cursos_mantenedor_factura.aspx.vb:btnInsertar_Click-->" & ex.Message)
        End Try
        Response.Redirect("ficha_curso_contratado.aspx?CodCurso=" & ViewState("CodCurso") & "&Origen=Aporte")
    End Sub
