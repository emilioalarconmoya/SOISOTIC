...
Partial Class Reportes_ficha_listado_alumnos
    ...
    Public Sub Consultar()
        ...
        hplBajarReporte.NavigateUrl = objCurso.ArchivoXml
    ...
    ' ''        hpl.NavigateUrl = "../fichas/ficha_alumno.aspx?rutAlumno=" & hdf.Value & "&tipo=" & hdfTip.Value
    ...
    Protected Sub grdResultados_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdResultados.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim lblViaticoOtic As Label
            lblViaticoOtic = CType(e.Row.FindControl("lblViaticoOtic"), Label)
            lblViaticoOtic.Text = FormatoPeso(lblViaticoOtic.Text)

            Dim lblViaticoEmp As Label
            lblViaticoEmp = CType(e.Row.FindControl("lblViaticoEmp"), Label)
            lblViaticoEmp.Text = FormatoPeso(lblViaticoEmp.Text)

            Dim lbl3 As Label
            lbl3 = CType(e.Row.FindControl("lblTraslado"), Label)
            lbl3.Text = FormatoPeso(lbl3.Text)

            Dim lblTrasladoOtic As Label
            lblTrasladoOtic = CType(e.Row.FindControl("lblTrasladoOtic"), Label)
            lblTrasladoOtic.Text = FormatoPeso(lblTrasladoOtic.Text)

            Dim lblTrasladoEmp As Label
            lblTrasladoEmp = CType(e.Row.FindControl("lblTrasladoEmp"), Label)
            lblTrasladoEmp.Text = FormatoPeso(lblTrasladoEmp.Text)
