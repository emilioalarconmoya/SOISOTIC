...
Partial Class modulo_cursos_carta_otec
    ...
    Public Sub Consultar()
        ...
        If objCartaOtec.CorrelativoCompl = -1 Then
            lblCorrelativoCompl.Text = "-"
        Else
            lblCorrelativoCompl.Text = objCartaOtec.CorrelativoCompl
        End If
        ...
        If objCartaOtec.CorrelativoEmp = "" Then
            lblCorrelativoEmp.Text = "-"
        Else
            lblCorrelativoEmp.Text = objCartaOtec.CorrelativoEmp
        End If
    ...
    Protected Sub btnGenerarPdf_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerarPdf.Click
        ...
        objGeneraCartaOtec.CartaOtec(Me.lblNombreContacto.Text, Me.lblCargoContacto.Text, Me.lblRazonSocial.Text, "", Me.lblContactoAd.Text, _
                                     ...
                                     ViewState("codCursoParcial"), ViewState("codCursoCompl"), lblValorHora.Text, lblCorrelativoEmp.Text, lblCorrelativoCompl.Text)
    ...
    Protected Sub btnGenerarExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerarExcel.Click
        ...
        Try
            ...
            objExcel.CartaOtec(Me.lblNombreContacto.Text, Me.lblCargoContacto.Text, Me.lblRazonSocial.Text, "", Me.lblContactoAd.Text, _
                                     ...
                                     hdfFonoCliente.Value, hdfGiroCliente.Value, Parametros.p_FONOEMPRESA, Parametros.p_GIROEMPRESA, lblValorHora.Text, _
                                     lblCorrelativoEmp.Text, lblCorrelativoCompl.Text)
