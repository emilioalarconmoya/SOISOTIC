...
Imports System
Imports System.Data
Partial Class modulo_cursos_ficha_curso_contratado
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        If ViewState("codEstadoCurso") = 1 Or ViewState("codEstadoCurso") = 0 Then
            Me.btnCambiaAIngresado.Visible = False
        End If
        ...
        End If
        Me.btnPopupEnviarCorreo.Attributes.Add("onClick", "popup_pos('enviar_correo.aspx?emailEmpresa=" & strEmailEmpresa & "&emailOtec=" & strEmailOtec & "&codCurso=" & ViewState("CodCurso") & "&rutUsuario=" & objSession.Rut & "', 'NewWindow1', 600, 900, 100, 100);return false;")
    ...
    Private Sub Consultar()
        Try
            Dim objCurso2 = New CFichaCursoContratado
            ...
            If objReporte.CodCursoCompl > 0 Then
                objCurso2.CodCurso = objReporte.CodCursoCompl
                objCurso2.RutCliente = objSession.Rut
                objCurso2.Agno = objSession.Agno
                objCurso2.Consultar()
            End If
            If objReporte.CodCursoParcial > 0 Then
                objCurso2.CodCurso = objReporte.CodCursoParcial
                objCurso2.RutCliente = objSession.Rut
                objCurso2.Agno = objSession.Agno
                objCurso2.Consultar()
            End If
            ...
            Me.lblCUhoras.Text = objReporte.Horas '+ objCurso2.Horas 'objReporte.HorasCompl
            ...
            Me.lblCodCurso.Text = objReporte.CodCurso
            ...
            Else
                Me.lblRegSence.Text = "--"
                Me.lkbtnBajarCertficado.Visible = False
            End If
            ...
            Else
                lblCorrelCompl.Text = "-"
            End If
            If objReporte.CodEstadoCurso = 0 Or objReporte.CodEstadoCurso = 1 Or objReporte.CodEstadoCurso = 2 Or objReporte.CodEstadoCurso = 3 _
              Or objReporte.CodEstadoCurso = 6 Or objReporte.CodEstadoCurso = 7 Or objReporte.CodEstadoCurso = 8 Or objReporte.CodEstadoCurso = 10 Then
                fupCertificadoAsist.Visible = False
            ...
            If ViewState("NroRegistro") = -1 Then
                Me.lkbtnBajarCertficado.Visible = False
            Else
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/ficha_curso_contratado--> Consultar" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnCambiaAIngresado_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCambiaAIngresado.Click
        Try
            ...
            objCursoContratado.Correlativo = Me.lblCorrelativo.Text.Trim
            objCursoContratado.Agno = objSession.Agno
            If objCursoContratado.CambiarEstIngresado("cambio de estado") Then
                body.Attributes.Add("onload", "alert('ATENCIÓN: El Curso ha sido cambiado a Estado INGRESADO ');")
                Consultar()
            Else
                body.Attributes.Add("onload", "alert('ATENCIÓN: El Curso no se puede cambia de estado ');")
            End If


        Catch ex As Exception
            EnviaError("modulo_cursos/ficha_curso_contratado--> btnCambiaAIngresado" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnPdfCursoContratado_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPdfCursoContratado.Click
        ...
        'Catch ex As Exception
        '    EnviaError("modulo_aporte/ficha_curso_contratado--> btnPdfCursoContratado_Click" & ex.Message)
        'End Try
    End Sub
    ...
    Protected Sub ValoresPdf()
        Try
            ...
            objGeneraFicha.Inicializar()
            objGeneraFicha.Correlativo = Me.lblCorrelativo.Text
            'objGeneraFicha.CodigoCurso = Me.lblCorrelEmp.Text
            objGeneraFicha.EstadoActual = hplEstado.Text
            objGeneraFicha.Fecha = Me.lblFecha.Text
            'objGeneraFicha.Origen = Me.lblOrigen.Text
            objGeneraFicha.FechaIngreso = Me.lblFechIngreso.Text
            objGeneraFicha.NSence = Me.lblRegSence.Text
            objGeneraFicha.NSenceCompl = Me.lblCorrelCompl.Text

            objGeneraFicha.NombreEmpresa = Me.hplDErazonSocial.Text
            objGeneraFicha.RutEmpresa = Me.lblDErutEmpresa.Text
            objGeneraFicha.ContactoEmpresa = Me.lblDEContacto.Text
            objGeneraFicha.CargoEmpresa = Me.lblDEcargo.Text
            objGeneraFicha.FonoEmpresa = Me.lblDEfono.Text
            'objGeneraFicha.FaxEmpresa = Me.lblDEfax.Text
            objGeneraFicha.MailEmpresa = Me.hplDEemail.Text

            objGeneraFicha.RazonSocial = Me.hplDOrazonSocial.Text
            objGeneraFicha.RutOtec = Me.lblDOrutOtec.Text
            objGeneraFicha.ContactoOtec = Me.lblDOcontacto.Text
            objGeneraFicha.CargoOtec = Me.lblDOcargo.Text
            objGeneraFicha.FonoOtec = Me.lblDOfono.Text
            'objGeneraFicha.FaxOtec = Me.lblDOfax.Text
            objGeneraFicha.MailOtec = Me.hplDOemail.Text

            objGeneraFicha.NombreCurso = Me.hplCUnombreCurso.Text
            objGeneraFicha.CodigoSenceCurso = Me.lblCUcodigosence.Text
            objGeneraFicha.HorasCurso = Me.lblCUhoras.Text
            objGeneraFicha.LugarCurso = Me.lblCUdireccion.Text & " " & Me.lblCUnumero.Text & " " & Me.lblCUciudad.Text
            objGeneraFicha.FechaInicioCurso = Me.lblCUfechaInicio.Text
            objGeneraFicha.FechaFinCurso = Me.lblCUfechaTermino.Text
            objGeneraFicha.ObservacionCurso = Me.lblObservacion.Text
            objGeneraFicha.ComunaCurso = Me.lblCUcomuna.Text & " " & Me.lblCUregion.Text

            objGeneraFicha.NumPartCosto = Me.lblCOnumParticipantes.Text
            objGeneraFicha.ViaticoCosto = Me.lblCOtotalviatico.Text
            objGeneraFicha.TransladoCosto = Me.lblCOtotalTraslado.Text
            objGeneraFicha.PorcAdminCosto = Me.lblCOporcAdmin.Text
            objGeneraFicha.BipartitoCosto = Me.lblCOcomiteBipartito.Text
            objGeneraFicha.NecesidadesCosto = Me.lblCOdetencionNecesidad.Text
            objGeneraFicha.PreContratoCosto = Me.lblCOpreContrato.Text
            objGeneraFicha.PosContratoCosto = Me.lblCOposContrato.Text

            objGeneraFicha.CPCostoOtic = Me.lblCPcostoOtic.Text
            objGeneraFicha.CPGastoEmpresa = Me.lblCPgastoEmpresa.Text
            objGeneraFicha.CPCostoAdmin = Me.lblCPCostoAdmin.Text
            objGeneraFicha.CPHoras = Me.lblCPhoras.Text
            objGeneraFicha.CPCuentaDeCap = Me.lblCPcuentaCap.Text
            objGeneraFicha.CPCuentaDeExc = Me.lblCPcuentaExcCap.Text
            objGeneraFicha.CPCuentaDeBecas = Me.lblCPcuentaBecas.Text
            objGeneraFicha.CPCuentaDeTerceros = Me.lblCPcuentaTerceros.Text

            objGeneraFicha.VTCostoOtic = Me.lblCPcostoOticVyT.Text
            objGeneraFicha.VTGastoEmpresa = Me.lblCPgastoEmpresaVyT.Text
            objGeneraFicha.VTCostoAdmin = Me.lblCPcostoAdminVyT.Text
            objGeneraFicha.VTCuentaDeCap = Me.lblCPTotalesCuentaCapVyT.Text
            objGeneraFicha.VTCuentaDeExc = Me.lblCPTotalesCuentaExcCapVyT.Text

            objGeneraFicha.TotalCostoOtic = Me.lblCPcostoOtic.Text
            objGeneraFicha.TotalGastoEmpresa = Me.lblCPgastoEmpresa.Text
            objGeneraFicha.TotalCostoAdmin = Me.lblCPCostoAdmin.Text
            objGeneraFicha.TotalCuentaDeCap = Me.lblCPtotalCuentaCapacitacion.Text
            objGeneraFicha.TotalCuentaDeExc = Me.lblCPtotalCuentaExcCapacitacion.Text
            objGeneraFicha.ValorCurso = lblCOvalorCurso.Text
            objGeneraFicha.nFactura = Me.lblNumFactura.Text
        Catch ex As Exception
            EnviaError("modulo_cursos/ficha_curso_contratado--> ValoresPdf" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnAgregaComentario_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregaComentario.Click
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/ficha_curso_contratado--> btnAgregaComentario_Click" & ex.Message)
        End Try
    End Sub
        ...
        If Me.fupCertificadoAsist.HasFile Then
            Try
                ...
                If strExtension = ".pdf" Then
                    ...
                    objCursoContratado.IngresaCertificado(ViewState("CodCurso"))
                ...
                End If
            Catch ex As Exception
                EnviaError("modulo_cursos/ficha_curso_contratado--> btnSubirArchivo_Click" & ex.Message)
            End Try
        Else
    ...
    Protected Sub grdComentarios_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdComentarios.RowDataBound
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/ficha_curso_contratado--> grdComentarios_RowDataBound" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnAutorizar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAutorizar.Click
        Try
            ...
            Consultar()
        Catch ex As Exception
            EnviaError("modulo_cursos/ficha_curso_contratado--> btnAutorizar_Click" & ex.Message)
        End Try
    End Sub
End Class
