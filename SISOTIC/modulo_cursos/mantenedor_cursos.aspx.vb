...
Imports System.io
Imports System.Xml
Partial Class modulo_cursos_mantenedor_cursos
...
#Region "Evantos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If Not ViewState("CodCurso") Is Nothing Then
                    ...
                    'objWeb.LlenaDDL(Me.ddlContactoPrincipal, objLookups.encargado(0), "rut_encargado", "nombre")
                    ...
                    If Me.txtRutEmpresa.Text <> "" Then
                        ...
                        Me.ddlContactoPrincipal.SelectedValue = objMantenedor.RutEncargado
                        'End If
                    End If
                Else
            ...
            Else
                ...
                If Me.txtRutEmpresa.Text <> "" Then
                    If My.Request.Params("__EVENTTARGET") = "CargaEmpresa" Then
                        If Not validarut(Me.txtRutEmpresa.Text.Trim) Then
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:Page_Load-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnRepetir_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRepetir.Click
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:btnRepetir_Click-->" & ex.Message)
        End Try
    ...
    Protected Sub btnTotal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTotal.Click
        Try
            CalculaValorFinal()
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:btnTotal_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnAgregarEmpReparto_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregarEmpReparto.Click
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:btnAgregarEmpReparto_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnActualizarRepartos_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnActualizarRepartos.Click
        Try
            ...
            CalcularMontosCuentas()
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:btnActualizarRepartos_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnSeleccionarTodos_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSeleccionarTodos.Click
        Try
            ...
            Next
        Catch ex As Exception
            EnviaError("modulo_cursos--mantenedor_cursos -- btnSeleccionarTodos_Click--" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnAgregarAlumno_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregarAlumno.Click
        Try
            ...
            '' '' ''***************************************************************
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:btnAgregarAlumno_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnCargarArchivo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCargarArchivo.Click
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:btnCargarArchivo_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnActualizaListaAlumnos_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnActualizaListaAlumnos.Click
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:btnActualizaListaAlumnos_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnBorrarHorario_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBorrarHorario.Click
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/mantenedor_cursos:btnBorrarHorario_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub rdbDescMonto_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rdbDescMonto.CheckedChanged
        Try
            CalculaValorFinal()
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:rdbDescMonto_CheckedChanged-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub rdbDescPorcentaje_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rdbDescPorcentaje.CheckedChanged
        Try
            CalculaValorFinal()
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:rdbDescPorcentaje_CheckedChanged-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub grdReparto_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdReparto.RowDataBound
        Try
            ...
            End If
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:grdReparto_RowDataBound-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub grdAlumnos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdAlumnos.RowDataBound
        Try
            ...
            End If
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:grdAlumnos_RowDataBound-->" & ex.Message)
        End Try
    End Sub
...
#Region "Cargas"
        ...
        Try
            If Not Me.txtRutEmpresa.Text.Trim = "" Then
                ...
                Else
                    ...
                    objWeb = New CWeb
                    If Me.ddlContactoPrincipal.SelectedValue = "" Then
                        Me.ddlContactoPrincipal.Items.Clear()
                    End If
                    objWeb.LlenaDDL(Me.ddlContactoPrincipal, objLookups.encargado(RutUsrALng(Me.txtRutEmpresa.Text.Trim)), "rut_encargado", "nombre")
            ...
            hdfFoco.Value = 1
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:CargaEmpresa--> " & ex.Message)
        End Try
    End Sub
        ...
        Try
            ...
            If respuesta_web <> "SIN_DATA" Then
                ...
                Else
                    ...
                    objMantenedorINS.NombreCurso = xml_NomCurso

                    objMantenedorINS.RutOtec = xml_RutOtec

                    objMantenedorINS.Area = xml_Area
                    objMantenedorINS.Especialidad = xml_Especialidad
                    objMantenedorINS.DurCurTeorico = CLng(xml_HorTeoricas)
                    objMantenedorINS.DurCurPractico = CLng(xml_HorPracticas)
                    objMantenedorINS.NumMaxParticipantes = CLng(xml_NumParticip)
                    ...
                    objMantenedorINS.CodComuna = CLng(xml_CodComunaSede)
                    objMantenedorINS.ValorCurso = CLng(xml_TotalCurso)
    ...
    Public Sub CargaCursoSence()
        Try
            ...
            hdfFoco.Value = 2
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:CargaCursoSence-->" & ex.Message)
        End Try
    End Sub
    ...
    Public Sub CargarDatos()
        Try
            ...
            If objMantenedor.RutEncargado <> 0 Then
                Me.ddlContactoPrincipal.SelectedValue = objMantenedor.RutEncargado
            End If
            ...
            objWeb = Nothing
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:CargarDatos-->" & ex.Message)
        End Try
    End Sub
    ...
    Public Sub CargaHorario()
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:CargaHorario-->" & ex.Message)
        End Try
    End Sub
...
#Region "Pasos"
    ...
    Public Sub StepActivo()
        If Me.wizardCurso.ActiveStep.ID = "WizardStep3" Then
            ...
            'Me.contenido.Attributes.Add("class", "Participantes")
            'Me.resultados.Style.Add("class", "Participantes")
            ...
            'Me.divdatagrid.Attributes.Add("class", "div-datagridParticipantes")
            'wizardCurso.SideBarStyle.CssClass = "sideBarButtomParticipantes"
        Else
            Me.contenedorCS.Attributes.Remove("class")
            ...
            Me.divdatagrid.Attributes.Remove("class")
            'Me.divdatagrid.Attributes.Add("class", "div-datagrid")
            'wizardCurso.SideBarStyle.CssClass = "sideBarButtom"
        End If
    End Sub
    ...
    Protected Sub StartNextButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Else
                ...
                If Me.txtValorHora.Text.Trim <> "" Then
                    objMantenedor.ValorHora = Me.txtValorHora.Text.Trim
                Else
                    objMantenedor.ValorHora = 0
                End If
                ...
                Else
                    objMantenedor.RutEncargado = Me.ddlContactoPrincipal.SelectedValue
                End If
                CargaHorario()
                'horasCurso()
                CantidadHoras()
        ...
        Catch ex As Exception
            Me.hdfEnvioDatos.Value = 0
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:StartNextButton_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub StepNextButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Catch ex As Exception
            Me.hdfEnvioDatos.Value = 0
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:StepNextButton_Click-->" & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub FinishButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Catch ex As Exception
            Me.hdfEnvioDatos.Value = 0
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:FinishButton_Click-->" & ex.Message)
        End Try
...
#Region "Funciones y metodos"
    ...
    Public Sub CalculaValorFinal()
        Try
            ...
            End If
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:CalculaValorFinal-->" & ex.Message)
        End Try
    End Sub
    ...
    Public Sub LlenaHorario()
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:LlenaHorario-->" & ex.Message)
        End Try
    End Sub
    ...
    Public Sub limpiaHorario()
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:limpiaHorario-->" & ex.Message)
        End Try
    End Sub
    ...
    Public Sub CantidadHoras()
        Try
            ...
            End If
        Catch ex As Exception
            EnviaError("modulo_curso --> mantenedor_curso --> cantidadHoras() " & ex.Message)
        End Try
    ...
    Public Sub ActualizarRepartos()
        Try
            ...
            objWeb = Nothing
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:ActualizarRepartos-->" & ex.Message)
        End Try
    End Sub
    ...
    Public Sub CalcularMontosCuentas()
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:CalcularMontosCuentas-->" & ex.Message)
        End Try
    End Sub
            ...
            If PermitirMasParticipantes(strRut) Then
                ...
                For Each grow In grdAlumnos.Rows
                    If Not CType(grow.FindControl("txtRUT"), TextBox).Text.Trim = "" Then
                        If validarut(CType(grow.FindControl("txtRUT"), TextBox).Text.Trim) Then
                            ...
                            'If objCurso.ExisteAlumnoEnCurso(RutUsrALng(CType(grow.FindControl("txtRUT"), TextBox).Text.Trim), Me.txtCodSence.Text.Trim, Me.ddlAgnoInicio.SelectedValue, RutUsrALng(Me.txtRutEmpresa.Text.Trim)) Then
                            '    body.Attributes.Add("onload", "alert('ATENCIÓN: El Alumno ingresado con rut " & CType(grow.FindControl("txtRUT"), TextBox).Text.Trim & ", no puede realizar el mismo curso 3 veces con la misma empresa');")
                            '    Exit Sub
                            'End If
                            dr = dt.NewRow
                            dr("rut") = CType(grow.FindControl("txtRUT"), TextBox).Text.Trim
                ...
                For i = 0 To TamanoArreglo1(strRut) - 1
                    If validarut(strRut(i).Trim) Then
                        ...
                        If AlertAlumnoConCursoRepetido(RutUsrALng(strRut(i).Trim)) Then
                            strRutsCursoRepetido = strRutsCursoRepetido & strRut(i).Trim & ", "
                        End If
                        If AlertAlumnoConTopeFechas(RutUsrALng(strRut(i).Trim)) Then
                            strRutsTopeHorario = strRutsTopeHorario & strRut(i).Trim & ", "
                        End If
...
moveNext:
            ...
            If strRutsErroneos.Length > 0 Then
                strRutsErroneos = "Los siguientes participantes no fueron cargado ya que el Rut ingresado es incorrecto:\n" & Left(strRutsErroneos, strRutsErroneos.Length - 2) & "\n"
            End If
            If strRutsYaCargados.Length > 0 Then
                strRutsYaCargados = "Los siguientes participantes ya figuran en la nómina del curso:\n" & Left(strRutsYaCargados, strRutsYaCargados.Length - 2) & "\n"
            End If


            If strRutsCursoRepetido.Length > 0 Or strRutsTopeHorario.Length > 0 Or strRutsErroneos.Length > 0 Or strRutsYaCargados.Length > 0 Then
                Me.body.Attributes.Add("onload", "alert('ATENCION:\n" & strRutsErroneos & strRutsYaCargados & strRutsCursoRepetido & strRutsTopeHorario & "');")
            End If
    ...
    Protected Function PermitirMasParticipantes(ByVal strRuts() As String) As Boolean
        Try
            ...
            Return permitir
        Catch ex As Exception
            EnviaError("modulo_cursos/mantenedor_cursos:ValidarMaximoPermitido-->" & ex.Message)
        End Try
    End Function

#End Region

#Region "Validaciones2"
    ...
    Public Function ValidaDatosPaso1() As Boolean
        ...
        Try
            ...
            If ViewState("modo") <> "actualizar" Then
                ...
                If Not ValidaDiasInscripcion(Now.Date, fechaInicio) Then
                    ViewState("MensajeError") = "alert('ATENCIÓN:El curso debe ser inscrito a los menos 2 días antes que comience la actividad, no contando el día sábado y domingo');"
                    ValidaDatosPaso1 = False
                    blnBloqueo = True
                    Exit Function
                End If
            ...
            If objSession.EsCliente Then
                If hora = 23 And minutos > 59 Then
                    ViewState("MensajeError") = "alert('ATENCIÓN: Este curso debería haber sido ingresado antes del " + Now.Day.ToString + "/" + Now.Month.ToString + "/" + Now.Year.ToString + " a las 23:59 hrs.\nPor favor comuníquese con Operaciones para confirmar el ingreso del curso.');"
                    ValidaDatosPaso1 = False
                    blnBloqueo = True
                    Exit Function
                ElseIf hora > 23 Then
                    ViewState("MensajeError") = "alert('ATENCIÓN: Este curso debería haber sido ingresado antes del a las " + Now.Day.ToString + "/" + Now.Month.ToString + "/" + Now.Year.ToString + " 23:59 hrs.\nPor favor comuníquese con Operaciones para confirmar el ingreso del curso.');"
                    ValidaDatosPaso1 = False
                    blnBloqueo = True
                    Exit Function
                End If
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:ValidaDatosPaso1-->" & ex.Message)
        End Try
    End Function
    ...
    Private Function ValidaHorario() As Boolean
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/matenedor_cursos.aspx.vb:ValidaHorario-->" & ex.Message)
        End Try
    End Function
...
#End Region
    ...
    ' ''    For Each dr In ViewState("dtHorario").Rows
    ' ''        Select Case dr("dia")
    ' ''            Case 1
    ' ''                horasLun = horasLun + Left(dr("HoraFin"), 2) - Left(dr("HoraInicio"), 2)
    ' ''                minLun = minLun + Right(dr("HoraFin"), 2) - Right(dr("HoraInicio"), 2)
    ' ''            Case 2
    ' ''                horasMar = horasMar + Left(dr("HoraFin"), 2) - Left(dr("HoraInicio"), 2)
    ' ''                minMar = minMar + Right(dr("HoraFin"), 2) - Right(dr("HoraInicio"), 2)
    ' ''            Case 3
    ' ''                horasMie = horasMie + Left(dr("HoraFin"), 2) - Left(dr("HoraInicio"), 2)
    ' ''                minMie = minMie + Right(dr("HoraFin"), 2) - Right(dr("HoraInicio"), 2)
    ' ''            Case 4
    ' ''                horasJue = horasJue + Left(dr("HoraFin"), 2) - Left(dr("HoraInicio"), 2)
    ' ''                minJue = minJue + Right(dr("HoraFin"), 2) - Right(dr("HoraInicio"), 2)
    ' ''            Case 5
    ' ''                horasVie = horasVie + Left(dr("HoraFin"), 2) - Left(dr("HoraInicio"), 2)
    ' ''                minVie = minVie + Right(dr("HoraFin"), 2) - Right(dr("HoraInicio"), 2)
    ' ''            Case 6
    ' ''                horasSab = horasSab + Left(dr("HoraFin"), 2) - Left(dr("HoraInicio"), 2)
    ' ''                minSab = minSab + Right(dr("HoraFin"), 2) - Right(dr("HoraInicio"), 2)
    ' ''            Case 7
    ' ''                horasDom = horasDom + Left(dr("HoraFin"), 2) - Left(dr("HoraInicio"), 2)
    ' ''                minDom = minDom + Right(dr("HoraFin"), 2) - Right(dr("HoraInicio"), 2)
    ' ''        End Select
    ' ''    Next
    ...
    ' ''                End If
    ' ''                For Each dr In dt.Rows
    ' ''                    If dr("rut") = CType(grdRow.FindControl("txtRut"), TextBox).Text Then
    ' ''                        dr("nombres") = CType(grdRow.FindControl("txtNombres"), TextBox).Text
    ' ''                        dr("apellido_paterno") = CType(grdRow.FindControl("txtApellidoPat"), TextBox).Text
    ' ''                        dr("apellido_materno") = CType(grdRow.FindControl("txtApellidoMat"), TextBox).Text
    ' ''                        dr("sexo") = CType(grdRow.FindControl("ddlSexo"), DropDownList).SelectedValue
    ...
    ' ''        dt.DefaultView.Sort = "RutLNG desc"
    ...
    'Public Sub AgregaFilaVacia()
    '    Try
    '        If IsNumeric(Me.txtNumParticipantes.Text.Trim) Then
    '            If Me.grdAlumnos.Rows.Count < Me.txtNumParticipantes.Text.Trim Then
    '                Dim i As Integer
    '                Dim Fila As GridViewRow
    '                For i = 0 To i = Me.txtNumParticipantes.Text.Trim - 1
    '                    'grdAlumnos.
    '                Next
    '            End If
    '        End If
    '    Catch ex As Exception
    '        EnviaError("modulo_cursos--mantenedor_cursos:AgregaFilaVacia-->" & ex.Message)
    '    End Try
    'End Sub

    'Public Sub QuitaFilasVacia()
    '    Try
    '        Dim QuitoFila As Boolean = False
    '        Dim Fila As GridViewRow
    '        While QuitoFila = False
    '            For Each Fila In Me.grdAlumnos.Rows
    '                If CType(Fila.FindControl(""), Label).Text.Trim = "" Then
    '                    Me.grdAlumnos.DeleteRow(Fila.RowIndex)
    '                    QuitoFila = True
    '                    Exit For
    '                End If
    '            Next
