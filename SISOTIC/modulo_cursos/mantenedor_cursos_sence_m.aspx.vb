...
Partial Class modulo_administracion_mantenedor_cursos_sence_m
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/mantenedor_cursos_sence_m:Page_Load-->" & ex.Message)
        End Try
    End Sub
    Public Sub Consultar()
        ...
        Catch ex As Exception
            EnviaError("modulo_cursos/mantenedor_cursos_sence_m:Consultar--> " & ex.Message)
        End Try
    ...
    Public Sub limpiar()
        Try
            ...
            Me.ddlComuna.SelectedValue = 132101
        Catch ex As Exception
            EnviaError("modulo_cursos/mantenedor_cursos_sence_m:limpiar-->" & ex.Message)
        End Try
    End Sub
